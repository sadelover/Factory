...
CEqmDrawDataReport::CEqmDrawDataReport(void)
	: m_pBitmap(NULL)
{
...
CEqmDrawDataReport* CEqmDrawDataReport::Copy(void)
{
	m_bNeedSave = true;
	return new CEqmDrawDataReport(*this);
}

void CEqmDrawDataReport::Draw(Gdiplus::Graphics *pGraphics, Image *pBitmap /*= NULL*/)
{
...
bool CEqmDrawDataReport::PointInMe(const Gdiplus::PointF& actPt) const
{
...
Direction CEqmDrawDataReport::PointIsSide(const Gdiplus::PointF& actPt)
{
	if (actPt.X <= m_pos.X
...
void CEqmDrawDataReport::DrawSelectEdge(Gdiplus::Graphics *pGraphics)
{
...
bool CEqmDrawDataReport::ChangeSize(const Gdiplus::PointF& actPt, Direction dir)
{
	if (m_dScale == 0)
	{
...
bool CEqmDrawDataReport::CopyProperty(CEqmDrawBase *pBase)
{
	return false;
}

bool CEqmDrawDataReport::ClonePropertyByDest(CEqmDrawBase *pBase)
{
...
void CEqmDrawDataReport::SetDefaultBitmap(Image* pBitmap)
{
	if (pBitmap != NULL)
	{
		m_pBitmap = pBitmap;
...
Image* CEqmDrawDataReport::GetDefaultBitmap()
{
	return m_pBitmap;
}

bool CEqmDrawDataReport::ShiftEqmtsUp(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y - MOVEDISTANCEBYKEY));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsDown(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y + MOVEDISTANCEBYKEY));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsLeft(void)
{
	SetPos(Gdiplus::PointF(GetPos().X - MOVEDISTANCEBYKEY, GetPos().Y));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsRight(void)
{
	SetPos(Gdiplus::PointF(GetPos().X + MOVEDISTANCEBYKEY, GetPos().Y));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsCtrlUp(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y - MOVEDISTANCEBYKEYCTRL));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsCtrlDown(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y + MOVEDISTANCEBYKEYCTRL));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsCtrlLeft(void)
{
	SetPos(Gdiplus::PointF(GetPos().X - MOVEDISTANCEBYKEYCTRL, GetPos().Y));
	return true;
}

bool CEqmDrawDataReport::ShiftEqmtsCtrlRight(void)
{
	SetPos(Gdiplus::PointF(GetPos().X + MOVEDISTANCEBYKEYCTRL, GetPos().Y));
	return true;
}
...
CString CEqmDrawDataReport::GetPath(void) const
{
	return m_strPath;
}

void CEqmDrawDataReport::SetPath(const CString strPath)
{
	m_strPath = strPath;
}
