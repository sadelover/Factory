...
CEqmDrawTemperDistri::CEqmDrawTemperDistri(void)
	: m_pBitmap(NULL)
{
...
CEqmDrawTemperDistri* CEqmDrawTemperDistri::Copy(void)
{
	m_bNeedSave = true;
	return new CEqmDrawTemperDistri(*this);
}

void CEqmDrawTemperDistri::Draw(Gdiplus::Graphics *pGraphics, Image *pBitmap /*= NULL*/)
{
...
bool CEqmDrawTemperDistri::PointInMe(const Gdiplus::PointF& actPt) const
{
...
Direction CEqmDrawTemperDistri::PointIsSide(const Gdiplus::PointF& actPt)
{
	if (actPt.X <= m_pos.X
...
void CEqmDrawTemperDistri::DrawSelectEdge(Gdiplus::Graphics *pGraphics)
{
...
bool CEqmDrawTemperDistri::ChangeSize(const Gdiplus::PointF& actPt, Direction dir)
{
	if (m_dScale == 0)
	{
...
bool CEqmDrawTemperDistri::CopyProperty(CEqmDrawBase *pBase)
{
	return false;
}

bool CEqmDrawTemperDistri::ClonePropertyByDest(CEqmDrawBase *pBase)
{
...
void CEqmDrawTemperDistri::SetDefaultBitmap(Image* pBitmap)
{
	if (pBitmap != NULL)
	{
		m_pBitmap = pBitmap;
...
Image* CEqmDrawTemperDistri::GetDefaultBitmap()
{
	return m_pBitmap;
}

bool CEqmDrawTemperDistri::ShiftEqmtsUp(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y - MOVEDISTANCEBYKEY));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsDown(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y + MOVEDISTANCEBYKEY));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsLeft(void)
{
	SetPos(Gdiplus::PointF(GetPos().X - MOVEDISTANCEBYKEY, GetPos().Y));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsRight(void)
{
	SetPos(Gdiplus::PointF(GetPos().X + MOVEDISTANCEBYKEY, GetPos().Y));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsCtrlUp(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y - MOVEDISTANCEBYKEYCTRL));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsCtrlDown(void)
{
	SetPos(Gdiplus::PointF(GetPos().X, GetPos().Y + MOVEDISTANCEBYKEYCTRL));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsCtrlLeft(void)
{
	SetPos(Gdiplus::PointF(GetPos().X - MOVEDISTANCEBYKEYCTRL, GetPos().Y));
	return true;
}

bool CEqmDrawTemperDistri::ShiftEqmtsCtrlRight(void)
{
	SetPos(Gdiplus::PointF(GetPos().X + MOVEDISTANCEBYKEYCTRL, GetPos().Y));
	return true;
}
...
vector<TemperDistriInfo> CEqmDrawTemperDistri::GetTemperDistri(void) const
{
	return m_vecTemperDistri;
}

void CEqmDrawTemperDistri::SetTemperDistri(const vector<TemperDistriInfo>& vecTemperDistri)
{
	m_vecTemperDistri = vecTemperDistri;
}

void CEqmDrawTemperDistri::AddTemperDistri(const TemperDistriInfo& temperDistri)
{
	m_vecTemperDistri.push_back(temperDistri);
}
