...
const WCHAR c_FolderDoesNotExist[] = _T("The folder:\n\n%s\n\ndoes not exist. Do you want the folder to be created?");
const WCHAR c_szErrInvalidPath[] = _T("The folder:\n\n%s\n\nis invalid. Please reenter.");
const WCHAR c_szErrCreatePath[] = _T("The folder:\n\n%s\n\ncan not be created. Please double check.");
