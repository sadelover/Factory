...
public:
	...
	// OPC specifics
	bool Connect ();
	bool ConnectRemote(CLSID clsid);
	...
	IOPCBrowseServerAddressSpace* GetIBrowse () {return m_pIBrowse ;}
...
private:
	...
	// OPC specifics
	MULTI_QI m_arrMultiQI [5];	// array of interfaces we will query for each server
