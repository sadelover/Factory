...
public:
	...
	void SetItemDescription (LPCTSTR strItemDescription) {m_strItemDescription = strItemDescription;}
	LPCTSTR GetItemDescription () {return (m_strItemDescription);}
